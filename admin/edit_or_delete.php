...
$sql="UPDATE ilmoitukset, osastot SET ylaosasto='$ylaosasto', tapahtumaAlkaa='$tapahtumaAlkaaPvm', klo_I='$klo_I',
 tapahtumaPaattyy='$tapahtumaPaattyyPvm', klo_II='$klo_II', avoinna='$avoinna', paikka='$paikka', tapahtumanOsoite='$tapahtumanOsoite', otsikko='$otsikko', sisalto='$sisalto', 
   nimi='$nimi', jakaja='$jakaja', kaupunki='$kaupunki', sahkoposti='$sahkoposti', puhelin='$puhelin', nettisivu='$nettisivu', 
 ilmoitusPoistuuAutomaattisesti='$ilmoitusPoistuuAutomaattisestiPvm', julkaistu='$julkaistu',
                        elokuvat='$elokuvat', 
...
<input class='lisaa_ilmoitus_lomake' type='text' name='paikka' placeholder='Esim. Kanneltalo, Teatteri Kallio...' maxlength='255' value='<?php echo htmlspecialchars($row['paikka'], ENT_QUOTES, 'UTF-8'); ?>'>
  ...
  <br>
  <p class='lomakkeenPalauteNegatiivinen_3'>Jos haluat säilyttää ilmoituksen nykyiset kuvat, 
      hyppää Kuvat-vaiheen yli.</p>
  <br class='br_muokkaa_katoaa'>
  <p class='lomakkeenPalauteNegatiivinen_3'>Jos haluat vaihtaa ilmoituksen nykyisiä kuvia 
      tai poistaa niitä, klikkaa alla olevaa Vaihda tai poista kuvia -nappia.</p>
  <br class='br_muokkaa_katoaa'>
  <p class='lomakkeenPalauteNegatiivinen_3'>Kuvien vaihtamis- ja poistamismahdollisuus 
      avautuu uuteen ikkunaan.</p>
  <br>

  <button id="vaihda_ja_poista_kuvia_linkki" type="button" onclick="h_vaihda_ja_poista_kuvia('<?=htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>')">Vaihda tai poista kuvia</button>

  <br>
  <br>
  <br>

  <label class="label_otsikko" for="nimi">*Ilmoittajan nimi: <span class='lomakkeenPalauteNegatiivinen'><?php echo $nimi_virhe; ?></span></label>
  <br> 
  ...
  <label class="label_otsikko" for="jakaja">Jakaja: <span class='lomakkeenPalauteNegatiivinen'><?php echo $jakaja_virhe; ?></span></label>
  <br> 
  <p class='lisaa_ilmoitus_alaohje'> 
      Jos Ilmoittajan nimi on Jaetaan.net tai Jaetaan.net automaatio, myös tämä kenttä täytetään. 
  </p>
  <p class='lisaa_ilmoitus_alaohje'> 
      Muutoin tämä kenttää jää tyhjäksi. 
  </p>  
  <input class="lisaa_ilmoitus_lomake" type="text" name="jakaja" maxlength="255" value="<?php echo htmlspecialchars($row['jakaja'], ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <input class='lisaa_ilmoitus_lomake' type='text' name='sahkoposti' placeholder='esimerkki@esimerkki.net' maxlength='255' value="<?php echo htmlspecialchars($row['sahkoposti'], ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <p class='lisaa_ilmoitus_alaohje'> 
      Jos ilmoitus on pysyvä, jätä tämä kenttä tyhjäksi.
  </p>
...
<form action="" method="post" enctype="multipart/form-data">
    <label class="label_otsikko" for="poista_ilmoitus">Jos haluat poistaa tämän ilmoituksen kokonaan, klikkaa 
