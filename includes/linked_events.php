...
<head>
  ...
  <title>Hallinnointi – Jaetaan.net</title>
  ...
  <tbody>
    ...
    <tr class='listaus_rivi_hallinnointi'>
      ...
      <td class='listaus_solu'>
        <a href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo $row["urlMuokkaaTaiPoista"]; ?>' target="_blank"> 
      ...
      <td class='listaus_solu'>
        <a id='listaus_otsikko' class='listaus_linkin_teksti' href="https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row['urlMuokkaaTaiPoista'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank">
        ...
        <a id='listaus_osasto' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank">
        ...
        <a id='listaus_paikka' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank">
        ...
        <a id='listaus_kaupunki' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank">
          <p id='listaus_kaupunki_p' class='p_katoavat'>
            <?php echo htmlspecialchars($row['kaupunki'], ENT_QUOTES, 'UTF-8'); ?>
          </p>
        </a>

        <a id='listaus_viikon_paiva_suomeksi' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank"> 
      ...
      <td class='listaus_solu paivays_katoaa'>
        ...
        <a id='listaus_tapahtuma_alkaa' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank"> 
          <p>
            <?php echo date_FIN(substr(htmlspecialchars($row['tapahtumaAlkaa'], ENT_QUOTES, "UTF-8"),0,10)); ?>
          </p>
        </a>
        
        <a id='listaus_klo_I' class='listaus_linkin_teksti' href='https://jaetaan.net/admin/linked_events_tapahtumat/h_l_e_muokkaa_tai_poista.php?urlMuokkaaTaiPoista=<?php echo htmlspecialchars($row["urlMuokkaaTaiPoista"], ENT_QUOTES, "UTF-8"); ?>' target="_blank">
          <p>
...
if ($total_pages <= 5) {
  for ($i=1; $i<=$total_pages; $i++) {
    if ($page_I == $i || $page_I == '' && $i == 1) {
      echo '<li class="pagination_lista"><a id="active" class="pagination" href="https://jaetaan.net/admin/linked_events_tapahtumat/?page=' . $i . '&Listaa_ilmoitukset=listaa+ilmoitukset#listaus_ankkuri_2">' . $i . '</a></li>';
    } 
    else {
      echo '<li class="pagination_lista"><a class="pagination" href="https://jaetaan.net/admin/linked_events_tapahtumat/?page=' . $i . '&listaa_ilmoitukset=Listaa+ilmoitukset#listaus_ankkuri_2">' . $i . '</a></li>';
    }
  }
} 
